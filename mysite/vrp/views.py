...
def car(request):
	fp = open('/home/ubuntu/stitp/mysite/vrp/3.1.html')
...
def rank(request):
	fp = open('/home/ubuntu/stitp/mysite/vrp/rank.html')
	t = template.Template(fp.read())
	fp.close()
	html = t.render(template.Context())
	return HttpResponse(html)
...
def link(request):
	fp = open('/home/ubuntu/stitp/mysite/vrp/link.html')
	t = template.Template(fp.read())
	fp.close()
	html = t.render(template.Context())
	return HttpResponse(html)
...
def receivejsongenetic(request):
	...
	if request.method == "POST":
		...
		fp4 = open('/home/ubuntu/stitp/mysite/vrp/static/datascale.txt','w')
		fp4.write(datadata1)
		fp4.close()
		...
		fp = open('/home/ubuntu/stitp/mysite/vrp/static/inputjson.txt', 'w')
		fp.write(jsondata)
		fp.close()
		fp3 = open('/home/ubuntu/stitp/mysite/vrp/static/inputjson.txt','r')
		city = json.load(fp3)
		...
		for i in range(1,ti+1):
			...
			temp = open('/home/ubuntu/stitp/mysite/vrp/static/temp.txt', 'w')
			temp.write(fname)
			temp.close()
			os.system("python /home/ubuntu/stitp/mysite/vrp/static/genetic.py")
			

			fp1 = open('/home/ubuntu/stitp/mysite/'+fname, 'r')
			t = json.load(fp1)
			times = t['time']
			arr.append(times)
			sum += times
		...
		#route = r['pathlist']
		#fp1.close()
		fp2 = open('/home/ubuntu/stitp/mysite/'+jsonname,'r')
		geneticoutputdata = fp2.read()
		fp2.close()
		fp5 = open('/home/ubuntu/stitp/mysite/vrp/static/linkoutputjson.txt','w')
...
def receivejsonclustering(request):
	...
	if request.method == "POST":
		...
		for i in range(1,ti+1):
			...
			temp.write(fname)
			temp.close()
			os.system("python /home/ubuntu/stitp/mysite/vrp/static/clustering.py")
...
def receivejsonant(request):
	...
	if request.method == "POST":
		...
		for i in range(1,ti+1):
			...
			temp.write(fname)
			temp.close()
			os.system("python /home/ubuntu/stitp/mysite/vrp/static/ant.py")
...
def linkdata(request):
	if request.method == "POST":
		fp1 = open('/home/ubuntu/stitp/mysite/vrp/static/datascale.txt','r')
		datascaleback = fp1.read()
		fp1.close()
		fp2 = open('/home/ubuntu/stitp/mysite/vrp/static/linkoutputjson.txt','r')
...
def rankruntime1(request):
	if request.method == "POST":
		con = MySQLdb.connect(host="127.0.0.1", user="root", passwd="cyq882023",db="vrpdatabase",port=3306)
		cur = con.cursor()
		cur.execute("select data,algorithm,language,round(time,3),round(pathlength,3),nowtime from vrp_record where data='3 3 2' order by cast(time as decimal(9,4)) asc")
...
def rankruntime2(request):
	if request.method == "POST":
		con = MySQLdb.connect(host="127.0.0.1", user="root", passwd="cyq882023",db="vrpdatabase",port=3306)
		cur = con.cursor()
		cur.execute("select data,algorithm,language,round(time,3),round(pathlength,3),nowtime from vrp_record where data='5 5 3' order by cast(time as decimal(9,4)) asc")
...
def rankruntime3(request):
	if request.method == "POST":
		con = MySQLdb.connect(host="127.0.0.1", user="root", passwd="cyq882023",db="vrpdatabase",port=3306)
		cur = con.cursor()
		cur.execute("select data,algorithm,language,round(time,3),round(pathlength,3),nowtime from vrp_record where data='8 8 4' order by cast(time as decimal(9,4)) asc")
...
def rankruntime4(request):
	if request.method == "POST":
		con = MySQLdb.connect(host="127.0.0.1", user="root", passwd="cyq882023",db="vrpdatabase",port=3306)
		cur = con.cursor()
		cur.execute("select data,algorithm,language,round(time,3),round(pathlength,3),nowtime from vrp_record where data='10 10 5' order by cast(time as decimal(9,4)) asc")
...
def rankruntime5(request):
	if request.method == "POST":
		con = MySQLdb.connect(host="127.0.0.1", user="root", passwd="cyq882023",db="vrpdatabase",port=3306)
		cur = con.cursor()
		cur.execute("select data,algorithm,language,round(time,3),round(pathlength,3),nowtime from vrp_record where data='20 20 10' order by cast(time as decimal(9,4)) asc")
...
def rankruntime6(request):
	if request.method == "POST":
		con = MySQLdb.connect(host="127.0.0.1", user="root", passwd="cyq882023",db="vrpdatabase",port=3306)
		cur = con.cursor()
		cur.execute("select data,algorithm,language,round(time,3),round(pathlength,3),nowtime from vrp_record where data='25 25 15' order by cast(time as decimal(9,4)) asc")
...
def rankruntime7(request):
	if request.method == "POST":
		con = MySQLdb.connect(host="127.0.0.1", user="root", passwd="cyq882023",db="vrpdatabase",port=3306)
		cur = con.cursor()
		cur.execute("select data,algorithm,language,round(time,3),round(pathlength,3),nowtime from vrp_record where data='30 30 20' order by cast(time as decimal(9,4)) asc")
